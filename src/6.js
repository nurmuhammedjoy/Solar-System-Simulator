...
  earthCloud: '/texture/8081_earthhiresclouds4K.png',
  moon: '/texture/moonmap4k.jpg',
  moonBump: '/texture/07_moonbump4k.jpg',
...
  marsColor: '/texture/mars_1k_color.jpg',
  jupiter: '/texture/8k_jupiter.jpg',
  uranus: '/texture/2k_uranus.jpg',
  neptune: '/texture/2k_neptune.jpg',
  uranusRing: '/texture/8k_saturn_ring_alpha.png',
  saturnRing: '/texture/8k_saturn_ring_alpha.png',
  saturn: '/texture/8k_saturn.jpg'
};
...
function createUranus() {
  ...
  // Uranus sphere
  const geometry = new THREE.IcosahedronGeometry(12, 16);
  const uranusMat = new THREE.MeshStandardMaterial({ map: loader.load('texture/8k_saturn.jpg') });
  uranus = new THREE.Mesh(geometry, uranusMat);
  uranus.name = 'uranus';
  uranus.position.set(0, 0, 0);
  uranus.add(createLabel('Seturn', new THREE.Vector3(0, 10, 0)));
  raycastable.push(uranus);
  scene.add(uranus);
  loader.load(
    '/texture/Untitled1_20250711225337.png',
    function (texture) {
      const ringGeometry = new THREE.RingGeometry(15, 35, 64);
      ...
      ring.rotation.x = 93 * (Math.PI / 180); 
...
function focusOn(object) {
 ...
 camera.position.copy(pos.clone().add(dir.multiplyScalar(80)));
